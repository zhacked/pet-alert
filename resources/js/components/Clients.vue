							...
							<v-simple-table class=" table-hover elevation-1">
								...
								<tbody>
									...
									<tr  v-for="clientData in client.data" :key="clientData.id" class="text-center">
                                        ...
                                        <td>
                                            <button class="btn btn-success"  @click="addPet()">
												<i class="fa fa-plus"></i> Add pet 
											</button>
                                        </td>

										<td>
											<button class="btn btn-primary"  @click="editModal(clientData)">
												<i class="fa fa-edit"></i> Update
											</button>

												<button class="btn btn-danger"  @click="deleteClient(clientData.id)">
